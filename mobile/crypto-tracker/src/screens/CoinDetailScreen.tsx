...
export function CoinDetailScreen({ route, navigation }: Props) {
  ...
  const chartPoints = coin.sparkline_in_7d?.price ?? [1, 2, 1.6, 2.8, 2.4, 3.3, 3.1, 4];
