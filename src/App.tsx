    ...
    <div className="site-shell">
      ...
      <main id="main">
        ...
        <section className="section-pad section-muted featured-work"><div className="container"><Reveal className="featured-work-card featured-work-card--architecture"><div className="featured-work-art featured-work-art--architecture" role="img" aria-label="Превью сайта архитектурного бюро"><span>АРХИТЕКТ / 03</span><strong>SPACE<br /><em>TO LIVE.</em></strong><i></i><b>ARCHITECTURE / BUILD / SERVICE</b></div><div className="featured-work-copy"><p className="eyebrow">Client website / architecture</p><h3>АРХИТЕКТ</h3><p>Сайт архитектурно-строительной организации: полный цикл, понятная подача преимуществ и заявка на консультацию.</p><div className="featured-work-tags"><span>HTML / CSS / JS</span><span>Landing</span><span>Responsive</span></div><a className="button button--primary" href="./arhitekt/" target="_blank" rel="noreferrer">Открыть сайт <ArrowUpRight /></a></div></Reveal></div></section>
         ...
         <section className="section-pad section-muted featured-work"><div className="container"><Reveal className="featured-work-card featured-work-card--desktop"><div className="featured-work-art featured-work-art--desktop" role="img" aria-label="Превью desktop-приложения Client Finder"><span>CLIENT FINDER / 04</span><div className="desktop-app-preview" aria-hidden="true"><div className="desktop-app-preview__topbar"><i></i><i></i><i></i><strong>Client Finder</strong><small>v1.0.0</small></div><div className="desktop-app-preview__body"><aside><b>CF</b><span className="is-active"></span><span></span><span></span><span></span></aside><div className="desktop-app-preview__content"><small>OVERVIEW / LEADS</small><h4>Дашборд</h4><div className="desktop-app-preview__metrics"><span><b>128</b><small>Всего лидов</small></span><span><b>24</b><small>Новых сегодня</small></span><span><b>76%</b><small>Средний score</small></span></div><div className="desktop-app-preview__chart"><i></i><i></i><i></i><i></i><i></i><i></i><i></i></div></div></div></div><b>ELECTRON / REACT / SQLITE</b></div><div className="featured-work-copy"><p className="eyebrow">Desktop app / lead management</p><h3>Client Finder</h3><p>Desktop-приложение для поиска и обработки лидов: собирает проекты из источников, оценивает их score, помогает вести воронку и готовить сообщения клиентам.</p><div className="featured-work-tags"><span>Electron</span><span>React / TypeScript</span><span>SQLite</span><span>HH / Telegram</span></div><a className="button button--primary" href="https://github.com/kosmik11-web/kosmik-portfolio/releases/latest/download/client-finder-windows.7z" target="_blank" rel="noreferrer">Скачать для Windows <ArrowUpRight /></a></div></Reveal></div></section>
